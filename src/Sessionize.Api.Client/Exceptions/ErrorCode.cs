...
public sealed class ErrorCode
{
    ...
    public static readonly ErrorCode InvalidApiId = new(nameof(InvalidApiId), "The API ID is invalid. It must be an alphanumeric string between 8 and 12 characters");
    public static readonly ErrorCode InvalidBaseUrl = new(nameof(InvalidBaseUrl), "The BaseUrl is invalid. It must be a valid HTTPS URL");
